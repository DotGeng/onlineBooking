...
public interface ProctorMapperCustome {
	...
	public List<ProctorCustome> getProctorList2(@Param("openBatch")Integer openBatch) throws Exception;
	//添加所有监考老师和考场信息
	...
	//根据id删除监考员信息和考试信息
	public void deleteProctorByExamID(@Param("examID")Integer examID) throws Exception;
	//查出所有的不重复的考试信息
	...
	public Integer getStudentBookingByExamId(@Param("examID") Integer examID) throws Exception;
}
