		...
		<div class="page ">
			...
			<div class="banneradd bor">
				...
				<div class="baBody">
					...
					<form action="<%=path %>/updateClassroomToDB.action" method="post">
						<div class="bbD"  >
							<input type="hidden" value="${classroomCustom.classroomname }" name="oldclassroomname" type="text"
								class="input3" />
							<input type="hidden" value="${classroomCustom.classroomid }" name="classroomid" type="text"
								class="input3" />
						</div>
						<div class="bbD">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机房名字：
						...
						<div class="bbD">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机房容量：<input value="${classroomCustom.maxsize }" name="maxsize" type="text"
								class="input3" required="required"/>
								<a href="<%=path %>/modifySeatPage.action?classRoom=${classroomCustom.classroomname }&classRoomSize=${classroomCustom.maxsize }&roomid=${classroomCustom.classroomid}">座位信息修改</a>
						</div>
